...
const UI = {
  en: {
    ...
    in_ai_rotation:'Recommended', learners:'learners', quiz_me:'Quiz me', modules_h:'Modules', tap_module:'Tap any module to play', coming_soon:'Coming soon', more_in:'More in', related_courses:'Related courses',
    ...
    badges_h:'Badges', badges_sub:'', locked_dot:'Locked ·', leaders_board:"Leader's board · this week", board_sub:'Friendly, resets every Monday. A little competition keeps everyone finishing.', keep_alive:'▲ Keep it alive',
    you:'you', xp_ahead_1:'is just', xp_ahead_2:'ahead of you — finish one module to catch up', top_board:"You're top of the board this week. Keep the grove growing.", path_points:'',
