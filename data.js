...
const UI = {
  en: {
    ...
    vc_title:'Proven', vc_sub:'Harder than completion: finished + passed a real-scenario check + proved you still know it a week later.', vc_ring:'verified',
    ...
    vcert_btn:'Verified certificate', vcert_locked:'Verified certificate unlocks with: completion + applied scenario + delayed retention check', hourlog_btn:'Hour log', cert_popup:'Allow pop-ups to open the certificate', ots_none:'Bitcoin anchoring: not yet stamped', ots_pending:'Bitcoin anchoring: submitted, waiting for a block (usually 1–2h)', ots_confirmed:'Anchored in Bitcoin block {b} — provably not back-dated',
    ...
    match_goal:'For your goal', missing_ask:'Not seeing what you need? Tell the AI →', missing_prompt:'Tell me what you’re looking for — a topic, a problem on the land, a skill — and I’ll find it or flag it for the Belong team to add. Your path only gets smarter when you push back on it.',
    ...
    generated_by_ai:'Generated by Belong AI · updated 2h ago', your_path_to:'Your path to', path_intro:'Built from your role, your last 6 assessments, and the skills gap analysis your manager shared. It reshapes itself every time you learn.', regenerate_path:'Regenerate path ↺', why_order:'Why this order?',
    ...
    library_title:'Library', courses_tended:'courses · tended by the Belong team, sequenced by Belong AI.', filter_library:'Filter the library…', all:'All', nothing_matches:'Nothing matches — try another filter or ask the AI tutor to find it.',
    ...
    tutor_name:'Belong AI Tutor', tutor_ai_note:'AI assistant — answers can be wrong; verify what matters.', tutor_demo:'● Demo mode · scripted replies', summarize_course:'Summarize this course', quiz_now:'Quiz me now', whats_due:"What's due?", build_path:'Build me a path', ask_anything:'Ask anything about your land or courses…',
  ...
  pt: {
    ...
    vc_title:'Comprovado', vc_sub:'Mais exigente que a conclusão: terminou + passou um teste de cenário real + provou que ainda sabe uma semana depois.', vc_ring:'verificado',
    ...
    vcert_btn:'Certificado verificado', vcert_locked:'O certificado verificado desbloqueia com: conclusão + exercício aplicado + verificação de retenção diferida', hourlog_btn:'Registo de horas', cert_popup:'Permita pop-ups para abrir o certificado', ots_none:'Ancoragem Bitcoin: ainda não carimbado', ots_pending:'Ancoragem Bitcoin: submetido, à espera de um bloco (normalmente 1–2h)', ots_confirmed:'Ancorado no bloco Bitcoin {b} — comprovadamente sem retrodatação',
    ...
    generated_by_ai:'Gerado pela IA da Belong · atualizado há 2h', your_path_to:'O seu percurso para', path_intro:'Criado a partir da sua função, das suas últimas 6 avaliações e da análise de lacunas de competências. Reorganiza-se sempre que aprende.', regenerate_path:'Regenerar percurso ↺', why_order:'Porquê esta ordem?',
    ...
    library_title:'Biblioteca', courses_tended:'cursos · cuidados pela equipa Belong, sequenciados pela IA da Belong.', filter_library:'Filtrar a biblioteca…', all:'Todos', nothing_matches:'Nada corresponde — experimente outro filtro ou peça ao tutor de IA.',
    ...
    tutor_name:'Tutor de IA Belong', tutor_ai_note:'Assistente de IA — as respostas podem conter erros; confirme o que for importante.', tutor_demo:'● Modo demo · respostas guionadas', summarize_course:'Resumir este curso', quiz_now:'Testar-me agora', whats_due:'O que falta entregar?', build_path:'Criar um percurso', ask_anything:'Pergunte sobre a sua terra ou cursos…',
