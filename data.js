/* ============ Belong Academy — catalog & seed data ============ */
...
/* The six Belong pillars — shown as a band under the hero */
const PILLARS = [
...
const PATH_RATIONALES = {
  en: [
    ...
    'Community paired with your current module — your tutor questions pointed there.',
    'Capstone moved closer — your scores say you\'re ready.'
  ],
  pt: [
    'Primeira avaliação forte — dois módulos introdutórios saltados.',
    'Natureza antecipada: as suas respostas mostraram que é a sua lacuna.',
    'Comunidade emparelhada com o módulo atual — as suas perguntas ao tutor apontaram para lá.',
...
const DEFAULT_STATE = {
  ...
  goal: 'The Belong Way',
  path: ['welcome-belong', 'art-of-hospitality', 'seasonal-table', 'growing-regenerating', 'belong-to-nature', 'community-circular'],
...
const UI = {
  en: {
    ...
    story_h:'My learning story', story_sub:'', story_btn:'Tell me where I am', story_refresh:'↺ Refresh',
    ...
    vc_title:'Proven', vc_sub:'Finished, tested, still remembered a week later.', vc_ring:'verified',
    vc_of:'{v} of {d} completed courses verified', vc_how:'Pass the quiz, then answer again a week later.',
    vc_events:'records', vc_intact:'verified', vc_broken:'chain broken — contact your admin',
    ...
    intent_h:'Take it home', intent_sub:'One small commitment makes learning 3× more likely to reach your real work. What will you apply this week?', intent_ph:'e.g. Greet every guest by name today', intent_save:'Commit', intent_saved:'Committed. We’ll check in with you in a week — good luck!',
    ...
    ev_export:'Download record', ev_export_done:'Evidence file exported — verifiable without us',
    mconf_h:'Confirm what reached the work', mconf_sub:'Your people said they applied what they learned. Confirming it turns a self-report into evidence — and only confirm what you actually saw.', mconf_yes:'I saw it', mconf_no:'Didn’t see it',
    mconf_done:'Confirmed — recorded on your manager record', mconf_noted:'Noted — recorded honestly',
    vc_confirmed:'{c} of {a} confirmed by a manager', vc_selfrep:'self-reported',
    vcert_btn:'Verified certificate', vcert_locked:'Not proven yet — finish, then answer again in a week.', hourlog_btn:'Hour log', cert_popup:'Allow pop-ups to open the certificate', ots_none:'Bitcoin anchoring: not yet stamped', ots_pending:'Bitcoin anchoring: submitted, waiting for a block (usually 1–2h)', ots_confirmed:'Anchored in Bitcoin block {b} — provably not back-dated',
    ...
    gdpr_title:'Privacy & your data', gdpr_sub:'Export or erase, anytime.', gdpr_export:'Download my data', gdpr_exported:'Your data file is downloading', gdpr_delete:'Delete my account', gdpr_delete_warn:'This permanently erases your account, progress, XP and badges for everyone. Type DELETE to confirm.', gdpr_deleted:'Account deleted. Be well', gdpr_recent_login:'For safety, sign in again first — then delete works.', gdpr_guest_note:'Guest data lives only on this device — deleting clears it here.',
    ...
    ai_overview:'Overview', my_path:'+ My Path', in_my_path:'✓ In My Path', complete:'complete', est:'est.', left:'left',
    your_ai_path:'Your path', completed:'Completed', scored:'scored', modules_skipped:'modules you already know',
    in_progress:'In progress', adapted_today:'adapted today', unlocks_after:'Unlocks after assessment', next_up:'Next up', locked:'Locked',
    continue_learning:'Continue learning', synced_devices:'Synced across your devices', assigned_you:'Assigned to you', from_stewardship:'From Belong · Stewardship',
    trending:'Trending at Belong', community_learning:'What the Belong community is learning', because_completed:'Because you completed', ai_recommendations:'AI recommendations', see_all:'See all →',
    generated_by_ai:'Generated by Belong AI · updated 2h ago', your_path_to:'Your path to', path_intro:'Shaped by your role and results. It adapts every time you learn.', regenerate_path:'Regenerate path ↺', why_order:'Why this order?',
    learning_streak:'Learning streak', personal_best:'▲ Personal best', this_week:'This week', vs_last_week:'▲ 38% vs last week', skills_verified:'Skills verified', from_quizzes:'from quizzes', avg_score:'Avg. assessment score', top_5:'— Top 5% at Belong',
    ...
    badges_h:'Badges', badges_sub:'', locked_dot:'Locked ·', leaders_board:'Leaderboard · this week', board_sub:'Friendly, resets every Monday. A little competition keeps everyone finishing.', keep_alive:'',
    ...
    ob_welcome:'Welcome to Belong', ob_step:'Step', ob_hi:'Welcome,', ob_pick_handle:"Pick a username — it's how others see you in the community.", ob_role_q:'And what do you do?', ob_q1:'What do you do?', ob_q1_sub:'The AI uses your role to seed your first learning path. You can change everything later.', ob_skip:'Skip — explore on my own', ob_continue:'Continue →',
    ...
    pal_courses:'Courses', pal_recent:'Recent',
    team_load_fail:"We couldn't load your team just now.", retry:'Retry',
    sim_no_credit:"Preview only — this doesn't count toward your training record. Mark it complete once you've watched it.",
    watch_more:'Watch the lesson through to record it.',
    no_access_h:"You don't have access to the team dashboard", no_access_b:'This dashboard is for team leads. If you should have access, ask your company administrator to add you.', back_home:'Back to home', analytics_sub:'Your progress, measured.',
    ob_need_role:'Pick what you do to continue.', ob_need_goal:'Pick a goal to continue.',
    ...
    tutor_name:'Belong AI Tutor', tutor_ai_note:'AI assistant — answers can be wrong; verify what matters.', tutor_demo:'● Demo mode · scripted replies', summarize_course:'Summarize', quiz_now:'Quiz me', whats_due:"What's due?", build_path:'Build a path', ask_anything:'Ask anything about your land or courses…',
    ...
    footer_tag:'· The learning academy of Belong',
    prof_title:'Profile', prof_sub:'', prof_edit:'Edit profile', prof_name:'Full name', prof_username:'Username', prof_role:'What you do', prof_goal:'Your learning goal', prof_save:'Save changes', prof_saved:'Profile saved', prof_via:'via', prof_signout:'Sign out', prof_guest:"You're exploring as a guest. Sign in to save your profile and progress to the cloud.", prof_signin:'Sign in',
    auth_welcome:'Welcome to Belong Academy', auth_sub:'Sign in to save your progress across every device.', auth_google:'Continue with Google', auth_or:'or', auth_email:'Email', auth_password:'Password', auth_name:'Your name',
    ...
    auth_consent:'I agree to Belong storing my learning progress to sync it across my devices (GDPR).', auth_consent_req:'Please accept the privacy notice to continue.', auth_working:'One moment…', auth_signout:'Sign out', auth_signed_as:'Signed in as',
  ...
  pt: {
    ...
    cert_title:'Certificado de Conclusão', cert_awarded:'Atribuído a', cert_for:'pela conclusão de', cert_dl:'Transferir certificado', cert_li:'Adicionar ao LinkedIn', certs_h:'Certificados', certs_sub:'', cert_none:'Termine um curso para ganhar o seu primeiro certificado.',
    ...
    story_h:'A minha história de aprendizagem', story_sub:'', story_btn:'Diz-me onde estou', story_refresh:'↺ Atualizar',
    ...
    vc_title:'Comprovado', vc_sub:'Concluído, testado, e ainda sabido uma semana depois.', vc_ring:'verificado',
    vc_of:'{v} de {d} cursos concluídos verificados', vc_how:'Passe o teste e responda de novo uma semana depois.',
    vc_events:'registos', vc_intact:'cadeia íntegra ✓', vc_broken:'cadeia quebrada — contacte o seu admin',
    ...
    intent_h:'Levar para o trabalho', intent_sub:'Um pequeno compromisso torna 3× mais provável que a aprendizagem chegue ao trabalho real. O que vai aplicar esta semana?', intent_ph:'ex.: Cumprimentar cada hóspede pelo nome', intent_save:'Comprometo-me', intent_saved:'Registado. Voltamos a perguntar daqui a uma semana — boa sorte!',
    ...
    ev_export:'Descarregar registo', ev_export_done:'Ficheiro de evidência exportado — verificável sem nós',
    mconf_h:'Confirmar o que chegou ao trabalho', mconf_sub:'A sua equipa diz que aplicou o que aprendeu. Confirmar transforma uma auto-declaração em evidência — confirme apenas o que viu mesmo.', mconf_yes:'Vi acontecer', mconf_no:'Não vi',
    mconf_done:'Confirmado — registado no seu registo de chefia', mconf_noted:'Registado com honestidade',
    vc_confirmed:'{c} de {a} confirmados por uma chefia', vc_selfrep:'auto-declarado',
    vcert_btn:'Certificado verificado', vcert_locked:'Ainda não comprovado — conclua e responda de novo daqui a uma semana.', hourlog_btn:'Registo de horas', cert_popup:'Permita pop-ups para abrir o certificado', ots_none:'Ancoragem Bitcoin: ainda não carimbado', ots_pending:'Ancoragem Bitcoin: submetido, à espera de um bloco (normalmente 1–2h)', ots_confirmed:'Ancorado no bloco Bitcoin {b} — comprovadamente sem retrodatação',
    ...
    ready_h:'Prontidão para a função', ready_sub:'', ready_gap:'Maior lacuna', ready_rec:'Recomendado para esta lacuna', ready_of:'do objetivo', ready_none:'Escolha uma função no seu perfil para ver a sua prontidão.',
    ask_more:'Pergunte à Academia: ', dig_h:'Esta semana na Belong', dig_sub:'Dois minutos por departamento — ligados ao todo.', pwa_t:'Leve a academia consigo', pwa_b:'Adicione a Belong ao ecrã principal — um toque, mesmo offline.', pwa_btn:'Instalar', pwa_ios:'No iPhone: toque em Partilhar e depois \u201cAdicionar ao ecrã principal\u201d.', comm_pin:'Fixar', comm_unpin:'Soltar', comm_delete:'Eliminar', comm_confirm_del:'Eliminar esta publicação para todos?', comm_confirm_del_reply:'Eliminar esta resposta?', comm_deleted:'Eliminado', comm_privacy:'O seu progresso é guardado na sua conta Belong (Firestore, UE) e só você — e os administradores da Belong — o podem ver. Ative ou desative os lembretes no seu perfil quando quiser.',
    ...
    match_goal:'Para o seu objetivo', missing_ask:'Não encontra o que precisa? Diga à IA →', missing_prompt:'Diga-me o que procura — um tema, um problema na terra, uma competência — e eu encontro-o ou sinalizo-o à equipa Belong para o criar. O seu percurso só fica mais inteligente quando o desafia.',
    ...
    search_ph:'Procurar cursos, a terra…', org:'Belong · Academia',
    featured_eyebrow:'Para si', match:'compatível', modules:'módulos', certified:'CERTIFICADO', featured_h:'Em Destaque', featured_sub:'Programas essenciais, em primeiro plano',
    all_levels:'Todos os níveis', Beginner:'Iniciante', Intermediate:'Intermédio', Advanced:'Avançado', 'All levels':'Todos os níveis',
    resume_module:'Retomar Módulo', course_details:'Detalhes', start_learning:'Começar', start_course:'Começar curso', rewatch:'Rever',
    ai_overview:'Visão da IA', my_path:'+ Meu Percurso', in_my_path:'✓ No Meu Percurso', complete:'concluído', est:'aprox.', left:'restantes',
    your_ai_path:'O seu percurso', completed:'Concluído', scored:'nota', modules_skipped:'módulos ignorados pela IA',
    ...
    continue_learning:'Continuar a aprender', synced_devices:'Sincronizado nos seus dispositivos', assigned_you:'Atribuído a si', from_stewardship:'De Belong · Zeladoria',
    trending:'Em Destaque na Belong', community_learning:'O que a comunidade Belong está a aprender', because_completed:'Porque concluiu', ai_recommendations:'Recomendações da IA', see_all:'Ver tudo →',
    generated_by_ai:'Gerado pela IA da Belong · atualizado há 2h', your_path_to:'O seu percurso para', path_intro:'Moldado pela sua função e resultados. Adapta-se sempre que aprende.', regenerate_path:'Regenerar percurso ↺', why_order:'Porquê esta ordem?',
    learning_streak:'Sequência de estudo', personal_best:'▲ Recorde pessoal', this_week:'Esta semana', vs_last_week:'▲ 38% vs semana passada', skills_verified:'Competências verificadas', from_quizzes:'de questionários', avg_score:'Nota média das avaliações', top_5:'— Top 5% na Belong',
    ...
    pal_courses:'Cursos', pal_recent:'Recentes',
    team_load_fail:'Não foi possível carregar a sua equipa.', retry:'Tentar novamente',
    sim_no_credit:'Pré-visualização — esta aula não conta para o seu registo de formação. Marque como concluída quando a tiver visto.',
    watch_more:'Veja a aula até ao fim para a registar.',
    no_access_h:'Sem acesso ao painel da equipa', no_access_b:'Este painel é para responsáveis de equipa. Se devia ter acesso, peça ao administrador da sua empresa para o adicionar.', back_home:'Voltar ao início', analytics_sub:'O seu progresso, medido.',
    ob_need_role:'Escolha o que faz para continuar.', ob_need_goal:'Escolha um objetivo para continuar.',
    ...
    tutor_name:'Tutor de IA Belong', tutor_ai_note:'Assistente de IA — as respostas podem conter erros; confirme o que for importante.', tutor_demo:'● Modo demo · respostas guionadas', summarize_course:'Resumir', quiz_now:'Testar-me', whats_due:'O que falta?', build_path:'Criar percurso', ask_anything:'Pergunte sobre a sua terra ou cursos…',
    ...
    footer_tag:'· A academia de aprendizagem da Belong',
    prof_title:'Perfil', prof_sub:'', prof_edit:'Editar perfil', prof_name:'Nome completo', prof_username:'Nome de utilizador', prof_role:'O que faz', prof_goal:'O seu objetivo de aprendizagem', prof_save:'Guardar alterações', prof_saved:'Perfil guardado', prof_via:'via', prof_signout:'Sair', prof_guest:'Está a explorar como convidado. Entre para guardar o seu perfil e progresso na cloud.', prof_signin:'Entrar',
    auth_welcome:'Bem-vindo à Belong Academy', auth_sub:'Entre para guardar o seu progresso em todos os dispositivos.', auth_google:'Continuar com Google', auth_or:'ou', auth_email:'Email', auth_password:'Palavra-passe', auth_name:'O seu nome',
    ...
    auth_consent:'Concordo que a Belong guarde o meu progresso para o sincronizar entre dispositivos (RGPD).', auth_consent_req:'Aceite o aviso de privacidade para continuar.', auth_working:'Um momento…', auth_signout:'Sair', auth_signed_as:'Sessão iniciada como',
