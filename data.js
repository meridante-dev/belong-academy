...
const UI = {
  en: {
    ...
    mode_hint:'💡 Hint', mode_coach:'🧭 Coach', mode_explain:'📖 Explain', mode_practice:'🎯 Practice',
    mode_tip_hint:'One small nudge — you find the answer', mode_tip_coach:'Questions that make you think', mode_tip_explain:'Teaches the concept with examples', mode_tip_practice:'Gives you an exercise to try',
  ...
  pt: {
    ...
    mode_hint:'💡 Pista', mode_coach:'🧭 Coach', mode_explain:'📖 Explicar', mode_practice:'🎯 Praticar',
    mode_tip_hint:'Um pequeno empurrão — a resposta é sua', mode_tip_coach:'Perguntas que fazem pensar', mode_tip_explain:'Ensina o conceito com exemplos', mode_tip_practice:'Dá-lhe um exercício para tentar',
