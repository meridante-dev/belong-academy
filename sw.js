...
const VERSION = 'belong-v3';
const CORE = ['./', './index.html', './brands/belong/brand.js', './core/brandkit.js', './core/styles.css', './core/app.js', './brands/belong/content.js', './data.js', './manifest.json', './favicon.svg', './icon-192.png', './icon-512.png', './og-image.png'];
