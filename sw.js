...
const VERSION = 'belong-v37';
const CORE = ['./', './index.html', './brands/belong/brand.js', './core/brandkit.js', './core/ots.js', './core/styles.css', './fonts/fonts.css', './core/app.js', './vendor/gsap.min.js', './vendor/ScrollTrigger.min.js', './brands/belong/content.js', './data.js', './manifest.json', './favicon.svg', './icon-192.png', './icon-512.png', './og-image.png'];
